...
object ColumnsAndExpressions extends App {
  ...
  // selecting (projecting), example of narrow transformation
  ...
  // adding a column
  val carsWithKg3DF = carsDF.withColumn("Weight_in_kg_3", col("Weight_in_lbs") / 2.3)
  // renaming a column
  ...
  val moviesReleaseDF3 = moviesDF.selectExpr("Title", "Release_Date")
  ...
  atLeastMediocreComediesDF3.show()
}
